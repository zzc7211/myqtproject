...
int main(int argc, char *argv[])
{
    ...
    */
    ...
    qInfo(QObject::tr("This software is packaged and released by Zhou Zichun. If you have any problems, please contact zhouzichun@huaqin.com").toUtf8());
    qInfo(QString("MyScrcpy %1 Have Fun").arg(QCoreApplication::applicationVersion()).toUtf8());
